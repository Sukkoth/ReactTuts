                                ...
                                <div className='w-full text-center lg:text-left'>
                                    ...
                                    <div className='relative max-w-sm mx-auto lg:mx-0'>
                                        <p className='mb-6 text-gray-400 leading-loose'>
                                            Easily track your income and
                                            expenses with this powerful and
                                ...
                                <div className='p-6 flex flex-wrap bg-gray-800 shadow-md rounded-lg'>
                                    ...
                                    <div className='w-full lg:w-2/3'>
                                        ...
                                        <p className='text-gray-500'>
                                            Stop struggling to keep track of
                                            everything manually
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className='mb-6 w-full lg:w-1/2 px-3'>
                                <div className='p-6 flex flex-wrap bg-gray-800 shadow-md rounded-lg'>
                                    ...
                                    <div className='w-full lg:w-2/3'>
                                        ...
                                        <p className='text-gray-500'>
                                            This app offers an easy way to track
                                            income and expenses for any type of
                                            project.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className='mb-6 lg:mb-0 w-full lg:w-1/2 px-3'>
                                <div className='p-6 flex flex-wrap bg-gray-800 shadow-md rounded-lg'>
                                    ...
                                    <div className='w-full lg:w-2/3'>
                                        ...
                                        <p className='text-gray-500'>
                                            Keep your project income and
                                            expenses organized with this handy
                                            app.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className='w-full lg:w-1/2 px-3'>
                                <div className='p-6 flex flex-wrap bg-gray-800 shadow-md rounded-lg'>
                                    ...
                                    <div className='w-full lg:w-2/3'>
                                        ...
                                        <p className='text-gray-500'>
                                            Keep your finances organized and
                                            under control with this app.
                                        </p>
                                    </div>
                                </div>
                            </div>
